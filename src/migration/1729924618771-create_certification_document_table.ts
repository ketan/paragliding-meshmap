...
export class CreateCertificationDocumentTable1729924618771 implements MigrationInterface {
  tableName = 'certification_documents'
    ...
    await queryRunner.createTable(
      new Table({
        ...
        columns: [
          ...
          { name: 'issuing_organization', type: 'text', isNullable: false },
          { name: 'certificate_number', type: 'text', isNullable: false },
